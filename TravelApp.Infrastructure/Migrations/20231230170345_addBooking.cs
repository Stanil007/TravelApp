    ...
    public partial class addBooking : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 12, 30, 17, 3, 44, 712, DateTimeKind.Local).AddTicks(9502), 1, new Guid("0b1ca85c-6d66-4a76-b583-7723302e8542") },
                    { 2, new DateTime(2023, 12, 30, 17, 3, 44, 712, DateTimeKind.Local).AddTicks(9534), 2, new Guid("c5766467-afbf-4e85-930c-871a2169959c") },
                    { 3, new DateTime(2023, 12, 30, 17, 3, 44, 712, DateTimeKind.Local).AddTicks(9537), 3, new Guid("c6649427-b81a-4dd3-8793-d1a7d3f1424d") },
                    { 4, new DateTime(2023, 12, 30, 17, 3, 44, 712, DateTimeKind.Local).AddTicks(9539), 4, new Guid("a04c6d0d-9e0f-4fa2-a7f6-4d61cf154c37") },
                    { 5, new DateTime(2023, 12, 30, 17, 3, 44, 712, DateTimeKind.Local).AddTicks(9541), 5, new Guid("9f17e229-a27e-4d05-beee-a2882cd42e18") }
                });
        }
